function CertificationCard({ certification }) {
    return (
        <div
            className="w-full rounded-3xl px-4 pt-8 shadow-lightTheme dark:shadow-darkTheme transition-all bg-containerColorLightTheme dark:bg-containerColorDarkTheme">
